    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                comment: "Tài khoản học viên và quản trị viên");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    filename = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false, comment: "Tên file HTML gốc, dùng làm game_id khi lưu tiến độ"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    pinyin = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    meaning = table.Column<string>(type: "text", nullable: false),
                    example_cn = table.Column<string>(type: "text", nullable: true),
                    example_py = table.Column<string>(type: "text", nullable: true),
                    example_vn = table.Column<string>(type: "text", nullable: true),
                    audio_url = table.Column<string>(type: "text", nullable: true),
                    meaning_en = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                comment: "Lưu lịch sử học tập/tra cứu của từng từ vựng riêng biệt");
