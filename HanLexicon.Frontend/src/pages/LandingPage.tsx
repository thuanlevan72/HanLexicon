...
export default function LandingPage() {
  return (
    <div className="overflow-x-hidden font-sans scroll-smooth">
            ...
            <div className="lg:w-7/12 w-full grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                ...
                >
                  ...
                  <p className="text-[15px] font-bold text-[#476C44] text-center px-1 leading-tight flex gap-1">{card.icon}{card.name}</p>
                </a>
              ))}
            </div>
      ...
      {/* Final CTA Section */}
      <section section id="contact" className="py-32 bg-brand-secondary relative overflow-hidden scroll-mt-20" >
